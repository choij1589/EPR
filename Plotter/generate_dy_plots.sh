...
python plotter.py --hist ZMass_ee --xAxis "MassZ(ee) [GeV]" --yAxis "A.U." --rebin -1
python plotter.py --hist ZMass_mm --xAxis "MassZ(#mu#mu) [GeV]" --yAxis "A.U." --rebin -1
...
python plotter.py --hist ptZ_mm --xAxis "p_{T} (Z_{#mu#mu})" --yAxis "A.U."
